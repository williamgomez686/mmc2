...
{
    public partial class AgregadoTablaTicket : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioAplicacionId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    Solucion = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    FechaSolucion = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    Tecnico = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
